...
\usepackage[body={6.8in, 9.2in}, top=1.1in]{geometry}
...
% Pretty fonts
\newfontfamily\russianfont[Script=Cyrillic]{Arno Pro}
\newfontfamily\englishfont[Script=Latin]{Adobe Garamond Pro}
